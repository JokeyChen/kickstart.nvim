...
-- Set fold method to indent, and default to unfold when opening new files
...
end, { desc = 'Copy the [C]urrent [P]ath to the clipboard' })
...
require('lazy').setup({
...

  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sg', require('fzf-lua').live_grep_glob, { desc = '[S]earch by [G]rep' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>ws', require('fzf-lua').lsp_document_symbols, '[W]orkspace [S]ymbols')
